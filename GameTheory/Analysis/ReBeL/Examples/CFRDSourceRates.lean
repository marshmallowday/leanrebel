...
theorem oldJoint_mass (tag : Bool) :
  ...
  cases tag <;>
    norm_num [oldJoint, FinDist.expect_mix, FinDist.expect_pure, FinDist.prob_pure_eq_ite]
...
theorem newJoint_mass (tag : Bool) :
  ...
  rw [FinDist.map_eq_bind, FinDist.prob_bind]
  cases tag <;>
    norm_num [newJoint, FinDist.expect_mix, FinDist.expect_pure, FinDist.prob_pure_eq_ite]
...
theorem joint_variation : FinDist.atomVariation oldJoint newJoint = 1 / 50 := by
  norm_num [FinDist.atomVariation, fourAtoms, oldJoint, newJoint, FinDist.prob_pure_eq_ite]
...
theorem concentrated_density (atom : Bool × Bool) :
  ...
  cases query <;> cases hidden <;>
    norm_num [concentrated, oldJoint, concentrationDensity, FinDist.prob_pure_eq_ite]
...
theorem density_weighted_variation :
  ...
  norm_num [fourAtoms, concentrationDensity, oldJoint, newJoint, FinDist.prob_pure_eq_ite]
